...
// +kubebuilder:rbac:groups=zack.my.domain,resources=z21s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=zack.my.domain,resources=z21s/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=zack.my.domain,resources=z21s/finalizers,verbs=update
